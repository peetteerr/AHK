...
priorKeyHandler(ih, vk, sc) {
    ...
    avra:=ih.input
    if(PriorKeys.Length()>70)
   {
 	PriorKeys.RemoveAt(30, 40)
   }else{
   }
   if (StrLen(avra)>50)
{
...
return
:*?B0:ke::
SendInput,{BackSpace 2}| |{left 1}
return
:*?:kee::
sendinput,k{^}1{Delete}
return
:*?:ke ::
sendinput,k{_}1{Delete}
return
...
:*:stryd::
asc("y_1,y_2,\dots ,y_n")
return

:*:strxd::
asc("x_1,x_2,\dots ,x_n")
return
:*:strad::
asc("a_1,a_2,\dots ,a_n")
return

:*:strxu::
asc("x^1,x^2,\dots ,x^n")
return
:*:strru::
asc("r^1,r^2,\dots ,r^n")
return
...
ToolTip
If (IME_GET()=1)
	ToolTip,英,A_CaretX,% A_CaretY-35 ;shift得反着提示，提示切换后的状态。
else
	ToolTip,中,A_CaretX,% A_CaretY-35
Sleep,150
ToolTip
return
:*:pii::\pi `
